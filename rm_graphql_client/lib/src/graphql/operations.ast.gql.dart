...
const FetchRecipeIngredients = _i1.OperationDefinitionNode(
    type: _i1.OperationType.query,
    name: _i1.NameNode(value: 'FetchRecipeIngredients'),
    variableDefinitions: [
...
const document =
    _i1.DocumentNode(definitions: [FetchRecipeList, FetchRecipeIngredients]);
